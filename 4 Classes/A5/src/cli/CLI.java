...
public final class CLI {
    ...
    /**
     * Ввод значения типа double
     * @param hint текстовая подсказка
     * @return введённое значение
     */
    public double getDouble(String hint) {
        Scanner in = new Scanner(System.in);
        if (hint != null) {
            if (!hint.isBlank()) System.out.print(hint + ": ");
        }
    ...
    /**
     * Введ текстовой строки
     * @param hint Подсказка пользователю
    ...
    public void waitForEnter() {
        getLine("Нажмите ВВОД для продолжения...");
    }
 
    /**
     * Создать из списка строк меню для int getChoice(Option[] list).
     * @param strings Список строк
     * @return 
     */
    public static Option[] buildMenu(LinkedList<String> strings) {
